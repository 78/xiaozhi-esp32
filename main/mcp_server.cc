...
void McpServer::AddCommonTools() {
    ...
    if (camera) {
        AddTool("self.camera.take_photo",
            ...
            "(e.g. reading text/labels). Accepted values: QQVGA, QVGA, HVGA, VGA, SVGA, XGA, HD, SXGA, UXGA. "
            "Leave empty to keep the board default. Higher resolutions use more RAM and take longer to upload.\n"
            "Return:\n"
            "  A JSON object that provides the photo information.",
            PropertyList({
                Property("question", kPropertyTypeString),
                Property("resolution", kPropertyTypeString, std::string())
            }),
