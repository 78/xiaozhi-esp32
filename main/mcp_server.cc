...
void McpServer::AddUserOnlyTools() {
    ...
    // AddUserOnlyTool("self.schedule.update_event",
    //     "更新日程事件。可以更新事件的任何属性。\n"
    //     "参数:\n"
    //     "  `event_id`: 事件ID（必需）\n"
    //     "  `title`: 新标题（可选）\n"
    ...
    //         Property("title", kPropertyTypeString, ""),
    //         Property("description", kPropertyTypeString, ""),
    //         Property("start_time", kPropertyTypeInteger, 0),
    //         Property("end_time", kPropertyTypeInteger, 0),
    //         Property("category", kPropertyTypeString, ""),
    //         Property("is_all_day", kPropertyTypeBoolean, false),
    //         Property("reminder_minutes", kPropertyTypeInteger, -1, 0, 1440)
    //     }),
    //     [&schedule_manager](const PropertyList& properties) -> ReturnValue {
    ...
    //         bool success = schedule_manager.UpdateEvent(
    ...
    //         } else {
    //             return "{\"success\": false, \"message\": \"事件更新失败\"}";
    //         }
    //     });
