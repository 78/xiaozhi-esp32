...
void LcdDisplay::SetupUI() {
    ...
    lv_obj_set_style_text_color(status_bar_, lv_palette_main(LV_PALETTE_PINK), 0);
    ...
    lv_obj_set_style_text_color(emotion_label_, lv_palette_main(LV_PALETTE_PINK), 0);
    ...
    lv_obj_set_style_text_color(chat_message_label_, lv_palette_main(LV_PALETTE_PINK), 0);
    ...
    lv_obj_set_style_text_color(network_label_, lv_palette_main(LV_PALETTE_PINK), 0);
    ...
    lv_obj_set_style_text_color(notification_label_, lv_palette_main(LV_PALETTE_PINK), 0);
    ...
    lv_obj_set_style_text_color(status_label_, lv_palette_main(LV_PALETTE_PINK), 0);

    mute_label_ = lv_label_create(status_bar_);
    lv_label_set_text(mute_label_, "");
    lv_obj_set_style_text_font(mute_label_, fonts_.icon_font, 0);
    lv_obj_set_style_text_color(mute_label_, lv_palette_main(LV_PALETTE_PINK), 0);

    battery_label_ = lv_label_create(status_bar_);
    lv_label_set_text(battery_label_, "");
    lv_obj_set_style_text_font(battery_label_, fonts_.icon_font, 0);
    lv_obj_set_style_text_color(battery_label_, lv_palette_main(LV_PALETTE_PINK), 0);
}
