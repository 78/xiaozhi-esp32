 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font /System/Library/Fonts/Supplemental/Arial Bold.ttf --size 72 --bpp 4 --range 0x30-0x3A --no-compress --format lvgl --lv-include lvgl.h --lv-font-name lv_font_digits_72 -o main/display/dashboard/fonts/font_digits_72.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 901, .adv_w = 641, .box_w = 24, .box_h = 52, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 1525, .adv_w = 641, .box_w = 36, .box_h = 52, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2461, .adv_w = 641, .box_w = 35, .box_h = 53, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 3389, .adv_w = 641, .box_w = 38, .box_h = 52, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4377, .adv_w = 641, .box_w = 35, .box_h = 52, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 5287, .adv_w = 641, .box_w = 35, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 6215, .adv_w = 641, .box_w = 34, .box_h = 52, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 7099, .adv_w = 641, .box_w = 35, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 8009, .adv_w = 641, .box_w = 35, .box_h = 53, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 8937, .adv_w = 384, .box_w = 10, .box_h = 37, .ofs_x = 7, .ofs_y = 0}
};
