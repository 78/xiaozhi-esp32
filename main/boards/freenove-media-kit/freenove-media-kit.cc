...
private:
    ...
    {
        adcButton0.OnClick([this]()
                           { ESP_LOGI(TAG, "adcButton0 Click"); });
        adcButton1.OnClick([this]()
                           { ESP_LOGI(TAG, "adcButton1 Click"); });
        adcButton2.OnClick([this]()
                           { ESP_LOGI(TAG, "adcButton2 Click"); });
        adcButton3.OnClick([this]()
                           { ESP_LOGI(TAG, "adcButton3 Click"); });
        adcButton4.OnClick([this]()
                           { ESP_LOGI(TAG, "adcButton4 Click"); });
    }
...
public:
    FreenoveMediaKit() : boot_button_(BOOT_BUTTON_GPIO), adcButton0(adc_btn_config0),
                         adcButton1(adc_btn_config1), adcButton2(adc_btn_config2),
                         adcButton3(adc_btn_config3), adcButton4(adc_btn_config4)
    {
        InitializeSpi();
