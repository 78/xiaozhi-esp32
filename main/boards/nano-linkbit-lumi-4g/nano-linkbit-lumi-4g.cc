...
#define TAG "NanoLinkBitLumi4G"

class NanoLinkBitLumi4G : public DualNetworkBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<NanoLinkBitLumi4G *>(arg);
...
public:
    NanoLinkBitLumi4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
...
DECLARE_BOARD(NanoLinkBitLumi4G);