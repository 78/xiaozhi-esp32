#ifndef _T_DECK_MAX_EPD_DISPLAY_H_
#define _T_DECK_MAX_EPD_DISPLAY_H_
...
class TDeckMaxEpdDisplay : public LcdDisplay {
public:
    TDeckMaxEpdDisplay();
    ~TDeckMaxEpdDisplay() override = default;
...
private:
    ...
    static constexpr size_t kFrameBytes = ((T_DECK_MAX_EPD_WIDTH + 7) / 8) * T_DECK_MAX_EPD_HEIGHT;
    static constexpr size_t kLvglBufferBytes = T_DECK_MAX_EPD_WIDTH * T_DECK_MAX_EPD_HEIGHT *
...
#endif  // _T_DECK_MAX_EPD_DISPLAY_H_
