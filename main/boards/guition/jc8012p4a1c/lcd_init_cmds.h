...
// Init sequence extracted from JC8012P4A1C vendor SDK (esp_lcd_jd9365 v1.0.2).
// Registry driver v2.0.2 defaults omit {0x80,0x01} (DSI 2-lane select), which
// leaves this panel with a dead DPI video path (DBI still responds to ID reads).
