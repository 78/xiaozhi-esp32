...
public:
    // 构造函数
    CompactMl307Board() : Ml307Board(ML307_TX_PIN, ML307_RX_PIN, 4096), // 初始化ML307模块
...
DECLARE_BOARD(CompactMl307Board); // 声明开发板