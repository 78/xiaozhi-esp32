...
#define TAG "FogSeekNanoAiya"

class FogSeekNanoAiya : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoAiya *>(arg);
...
public:
    FogSeekNanoAiya() : boot_button_(BOOT_BUTTON_GPIO), ctrl_button_(CTRL_BUTTON_GPIO)
    {
        InitializeI2c();
