...
#define TAG "EdgeLinkBitVison4G"

class EdgeLinkBitVison4G : public DualNetworkBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<EdgeLinkBitVison4G *>(arg);
...
public:
    EdgeLinkBitVison4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
...
DECLARE_BOARD(EdgeLinkBitVison4G);