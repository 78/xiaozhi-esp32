...
#define TAG "FogSeekNanoLinkBitVision4G"

class FogSeekNanoLinkBitVision4G : public DualNetworkBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoLinkBitVision4G *>(arg);
...
public:
    FogSeekNanoLinkBitVision4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
...
DECLARE_BOARD(FogSeekNanoLinkBitVision4G);