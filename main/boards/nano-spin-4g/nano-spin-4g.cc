...
#define TAG "NanoSpin4G"

class NanoSpin4G : public DualNetworkBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<NanoSpin4G *>(arg);
...
public:
    NanoSpin4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
