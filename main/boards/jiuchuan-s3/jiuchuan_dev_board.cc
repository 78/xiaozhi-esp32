...
public:
        ...
        : SpiLcdDisplay(io_handle, panel_handle, width, height, offset_x, offset_y, mirror_x, mirror_y, swap_xy)
    {
        ...
        // 状态栏容器适配
        lv_obj_set_style_pad_left(top_bar_, LV_HOR_RES * 0.11, 0);  // 
        lv_obj_set_style_pad_right(top_bar_, LV_HOR_RES * 0.11, 0); // 
        // 表情容器上移适配
        lv_obj_align(emoji_box_, LV_ALIGN_CENTER, 0, -50);          // 向上偏移50
        // 消息栏适配
        lv_obj_align(bottom_bar_, LV_ALIGN_BOTTOM_MID, 0, -30);     // 
