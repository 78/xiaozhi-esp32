...
class ESP32_CGC_144_LcdDisplay : public Display {
protected:
...
public:
    ESP32_CGC_144_LcdDisplay(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
                  gpio_num_t backlight_pin, bool backlight_output_invert,
                  int width, int height,  int offset_x, int offset_y, bool mirror_x, bool mirror_y, bool swap_xy,
                  DisplayFonts fonts);
    ~ESP32_CGC_144_LcdDisplay();
