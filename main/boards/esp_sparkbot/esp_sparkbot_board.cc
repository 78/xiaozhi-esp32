...
class SparkbotDisplay : public LcdDisplay {
private:    
    lv_obj_t *user_messge_label_ = nullptr;
    lv_obj_t *ai_messge_label_ = nullptr;
public:
    SparkbotDisplay(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
...
private:
    ...
    void InitializeDisplay() {
        ...
        display_ = new SparkbotDisplay(panel_io, panel, DISPLAY_BACKLIGHT_PIN, DISPLAY_BACKLIGHT_OUTPUT_INVERT,
