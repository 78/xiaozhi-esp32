...
Button::Button(const button_adc_config_t &adc_cfg) {
  button_config_t button_config = {.type = BUTTON_TYPE_ADC,
...
void Button::OnPressDown(std::function<void()> callback) {
  ...
  iot_button_register_cb(
      button_handle_, BUTTON_PRESS_DOWN,
...
void Button::OnPressUp(std::function<void()> callback) {
  ...
  iot_button_register_cb(
      button_handle_, BUTTON_PRESS_UP,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
...
void Button::OnLongPress(std::function<void()> callback) {
  ...
  iot_button_register_cb(
      button_handle_, BUTTON_LONG_PRESS_START,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
...
void Button::OnClick(std::function<void()> callback) {
  ...
  on_click_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_SINGLE_CLICK,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_click_) {
          button->on_click_();
...
void Button::OnDoubleClick(std::function<void()> callback) {
  ...
  iot_button_register_cb(
      button_handle_, BUTTON_DOUBLE_CLICK,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
...
Button::Button(const button_adc_config_t &adc_cfg) {
  ...
  esp_err_t err =
      iot_button_new_adc_device(&button_config, &adc_cfg, &button_handle_);
  if (err != ESP_OK) {
...
Button::Button(gpio_num_t gpio_num, bool active_high) : gpio_num_(gpio_num) {
  ...
  esp_err_t ret = iot_button_new_gpio_device(&button_config, &btn_gpio_cfg,
                                             &button_handle_);
  if (ret != ESP_OK) {
...
void Button::OnPressDown(std::function<void()> callback) {
  ...
  on_press_down_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_PRESS_DOWN, NULL,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_press_down_) {
          button->on_press_down_();
...
void Button::OnPressUp(std::function<void()> callback) {
  ...
  on_press_up_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_PRESS_UP, NULL,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_press_up_) {
          button->on_press_up_();
...
void Button::OnLongPress(std::function<void()> callback) {
  ...
  on_long_press_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_LONG_PRESS_START, NULL,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_long_press_) {
          button->on_long_press_();
...
void Button::OnClick(std::function<void()> callback) {
  ...
  on_click_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_SINGLE_CLICK, NULL,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_click_) {
          button->on_click_();
...
void Button::OnDoubleClick(std::function<void()> callback) {
  ...
  on_double_click_ = callback;
  iot_button_register_cb(
      button_handle_, BUTTON_DOUBLE_CLICK, NULL,
      [](void *handle, void *usr_data) {
        Button *button = static_cast<Button *>(usr_data);
        if (button->on_double_click_) {
          button->on_double_click_();
