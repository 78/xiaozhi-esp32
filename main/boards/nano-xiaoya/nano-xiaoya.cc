...
#define TAG "NanoXiaoYa"

class NanoXiaoYa : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<NanoXiaoYa *>(arg);
...
public:
    NanoXiaoYa() : boot_button_(BOOT_BUTTON_GPIO), ctrl_button_(CTRL_BUTTON_GPIO)
    {
        InitializeI2c();
