...
#ifndef CAM_SHARE_I2C_PORT
#define CAM_PIN_SIOD    GPIO_NUM_4 
#define CAM_PIN_SIOC    GPIO_NUM_5
#else
#define CAM_PIN_SIOD    GPIO_NUM_NC //share I2C port with audio codec
#define CAM_PIN_SIOC    GPIO_NUM_NC //share I2C port with audio codec
