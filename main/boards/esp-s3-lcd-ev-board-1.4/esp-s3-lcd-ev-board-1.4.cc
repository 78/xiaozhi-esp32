...
#define TAG "ESP_S3_LCD_EV_Board_1_4"

LV_FONT_DECLARE(font_puhui_30_4);
LV_FONT_DECLARE(font_awesome_30_4);

class ESP_S3_LCD_EV_Board_1_4 : public WifiBoard {
private:
...
public:
    ESP_S3_LCD_EV_Board_1_4() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeCodecI2c();
        InitializeButtons();
        InitializeIot();
...
DECLARE_BOARD(ESP_S3_LCD_EV_Board_1_4);
