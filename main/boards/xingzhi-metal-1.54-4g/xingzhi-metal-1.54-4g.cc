...
#define TAG "XINGZHI_METAL_1_54_4G"

class XINGZHI_METAL_1_54_4G : public DualNetworkBoard {
private:
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnEnterSleepMode([this]() {
            ...
            power_manager_->Enter_SleepModem();
            GetBacklight()->SetBrightness(1);
        });
        power_save_timer_->OnExitSleepMode([this]() {
            display_->SetChatMessage("system", "");
            display_->SetEmotion("neutral");
            power_manager_->Exit_SleepModem();
...
public:
    XINGZHI_METAL_1_54_4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
...
DECLARE_BOARD(XINGZHI_METAL_1_54_4G);
