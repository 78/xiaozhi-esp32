...
private:
    ...
    void CheckBatteryStatus() {
        ...
        ESP_ERROR_CHECK(adc_oneshot_read(adc_handle_, POWER_USB_ADC_CHANNEL, &usb_usb_adc_value0));
...
public:
    PowerManager(gpio_num_t pin) : charging_pin_(pin) {
        ...
        ESP_ERROR_CHECK(adc_oneshot_config_channel(adc_handle_, POWER_BARRY_ADC_CHANNEL, &chan_config)); // 电池电量
        ESP_ERROR_CHECK(adc_oneshot_config_channel(adc_handle_, POWER_USB_ADC_CHANNEL, &chan_config)); // usb
    }
