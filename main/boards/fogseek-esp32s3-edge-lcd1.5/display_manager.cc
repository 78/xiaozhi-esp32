...
static const st77916_lcd_init_cmd_t lcd_init_cmds[] = {
    ...
    // 最终显示设置
    {0x3A, (uint8_t[]){0x05}, 1, 0},   // 像素格式
    {0x35, (uint8_t[]){0x00}, 1, 0},   // 撕裂效果线
    {0x21, (uint8_t[]){0x00}, 1, 0},   // 显示反转
    {0x11, (uint8_t[]){0x00}, 1, 120}, // 退出睡眠模式，延时120ms
    {0x29, (uint8_t[]){0x00}, 1, 0},   // 开启显示
};
...
void DisplayManager::Initialize()
{
    ...
    backlight_->SetBrightness(0); // 初始化时关闭屏幕背光
