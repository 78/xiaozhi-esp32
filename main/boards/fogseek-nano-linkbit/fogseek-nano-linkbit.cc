...
#define TAG "FogSeekNanoLinkBit"

class FogSeekNanoLinkBit : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoLinkBit *>(arg);
...
public:
    FogSeekNanoLinkBit() : boot_button_(BOOT_BUTTON_GPIO), ctrl_button_(CTRL_BUTTON_GPIO)
    {
        InitializeI2c();
...
DECLARE_BOARD(FogSeekNanoLinkBit);