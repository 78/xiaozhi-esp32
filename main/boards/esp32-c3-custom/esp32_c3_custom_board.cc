...
#define TAG "ESP32C3CustomBoard"

class Esp32C3CustomBoard : public WifiBoard {
private:
    ...
    void InitializePowerSaveTimer() {
        // Disable automatic power save to keep wake-word detection active.
...
public:
    ...
    virtual void SetPowerSaveLevel(PowerSaveLevel level) override {
        if (level != PowerSaveLevel::LOW_POWER && power_save_timer_) {
...
DECLARE_BOARD(Esp32C3CustomBoard);
