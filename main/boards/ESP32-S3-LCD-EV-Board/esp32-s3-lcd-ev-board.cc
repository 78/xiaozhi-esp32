...
#define TAG "ESP32_S3_LCD_EV_Board"

LV_FONT_DECLARE(font_puhui_30_4);
LV_FONT_DECLARE(font_awesome_30_4);

class ESP32_S3_LCD_EV_Board : public WifiBoard {
private:
...
public:
    ESP32_S3_LCD_EV_Board() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeCodecI2c();
        InitializeButtons();
        InitializeIot();
...
DECLARE_BOARD(ESP32_S3_LCD_EV_Board);
