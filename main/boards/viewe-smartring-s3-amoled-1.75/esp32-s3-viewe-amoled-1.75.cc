...
private:
    ...
    void InitializeTouch() {
        ...
        const esp_lcd_touch_config_t tp_cfg = {
            .x_max = QSPI_LCD_WIDTH_RES,
            .y_max = QSPI_LCD_HEIGHT_RES,
        ...
        esp_lcd_panel_io_i2c_config_t tp_io_config = LOCAL_LCD_TOUCH_IO_I2C_CST9217_CONFIG();
      
        esp_lcd_new_panel_io_i2c(i2c_bus_, &tp_io_config, &tp_io_handle);
        esp_lcd_touch_new_i2c_cst9217(tp_io_handle, &tp_cfg, &touch_handle_);
        ...
        if (touch_handle_) {
            ...
            ESP_LOGE(TAG, "Touch panel bind lvgl failed");
        }
    }
