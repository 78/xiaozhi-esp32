...
#define LOCAL_LCD_TOUCH_IO_I2C_CST9217_ADDRESS    0x15//0x5A//(0x15)  //CST9217 是  0x5A

#define LOCAL_LCD_TOUCH_IO_I2C_CST9217_CONFIG()             \
{                                                    \
    .dev_addr = LOCAL_LCD_TOUCH_IO_I2C_CST9217_ADDRESS, \
