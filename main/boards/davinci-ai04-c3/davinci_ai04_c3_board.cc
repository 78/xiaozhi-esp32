...
#define TAG "DavinciAi04C3Board"

LV_FONT_DECLARE(font_puhui_14_1);
LV_FONT_DECLARE(font_awesome_14_1);

class DavinciAi04C3Board : public WifiBoard {
private:
...
public:
    DavinciAi04C3Board() : boot_button_(BOOT_BUTTON_GPIO) {  
...
DECLARE_BOARD(DavinciAi04C3Board);
