...
static const st7102_lcd_init_cmd_t st7102_init_cmds[] = {
    ...
    {.cmd = 0xA3,
     ...
     .delay_ms = 0},
    {.cmd = 0xA6,
     .data = (uint8_t[]){0x02, 0x00, 0x24, 0x55, 0x35, 0x00, 0x38, 0x00, 0x97, 0x97, 0x00, 0x24, 0x55, 0x36, 0x00,
...
private:
    ...
    void InitializeIoExpander() {
        ioe_ = new M5IOE1();
        ESP_ERROR_CHECK(ioe_->begin(i2c_bus_, IOE1_I2C_ADDR));
        ...
        ioe_->digitalWrite(IOE1_PIN_LCD_RST, LOW);
    ...
    static esp_err_t EnableDsiPhyPower() {
        ...
        ESP_RETURN_ON_ERROR(esp_ldo_acquire_channel(&ldo_cfg, &phy_pwr_chan), TAG, "Acquire DPHY LDO failed");
    ...
    void InitializeDisplay() {
        ESP_ERROR_CHECK(EnableDsiPhyPower());
        ...
        esp_lcd_dpi_panel_config_t dpi_config = {
            ...
            .dpi_clock_freq_mhz = DISPLAY_PIXEL_CLOCK_MHZ,
    ...
    void InitializeTouch() {
        ...
        esp_lcd_panel_io_i2c_config_t tp_io_config = ESP_LCD_TOUCH_IO_I2C_CST3XX_CONFIG();
        tp_io_config.dev_addr = ESP_LCD_TOUCH_IO_I2C_CST3XX_ADDRESS;
        tp_io_config.scl_speed_hz = 400000;
        ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c(i2c_bus_, &tp_io_config, &tp_io_handle));
        ESP_ERROR_CHECK(esp_lcd_touch_new_i2c_cst3xx(tp_io_handle, &tp_cfg, &tp));
