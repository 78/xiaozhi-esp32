...
#define TAG "Sph0645AudioCodec"

Sph0645AudioCodec::Sph0645AudioCodec(int input_sample_rate,
...
Sph0645AudioCodec::~Sph0645AudioCodec() {
...
int Sph0645AudioCodec::Write(const int16_t* data, int samples) {
...
int Sph0645AudioCodec::Read(int16_t* dest, int samples) {
  size_t bytes_read;
