...
#else
//GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=*/ EPD_PIN_NUM_CS, /*DC=*/ EPD_PIN_NUM_DC, /*RST=*/ EPD_PIN_NUM_RST, /*BUSY=*/ EPD_PIN_NUM_BUSY)); // Good Display ESP32 Development Kit ESP32-L
// 用typedef 简化类型书写
