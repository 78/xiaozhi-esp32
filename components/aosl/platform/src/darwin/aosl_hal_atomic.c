/* Darwin/iOS HAL atomic operations - identical to Linux (GCC builtins work on Apple Clang) */
...
void aosl_hal_mb()  { __sync_synchronize(); }
void aosl_hal_rmb() { __sync_synchronize(); }
void aosl_hal_wmb() { __sync_synchronize(); }
